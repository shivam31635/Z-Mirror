...
async def update_user_settings(query):
    ...
    if not ospath.exists(tpath):
        tpath = "https://telegra.ph/file/e03469a2c316efadf2606.jpg"
...
Examples:
1. <code>{escape('<b>Join: @Crazybotz</b>')}</code> 
This will give output as:
<b>Join: @Crazybotz</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @Crazybotz</code>')}</code> 
This will give output as:
<code>Join: @Crazybotz</code> <code>69MB.bin</code>.
